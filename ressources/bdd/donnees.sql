...
-- Vider les tables avant réinsertion (l'ordre est important à cause des clés étrangères)
TRUNCATE TABLE
...
-- ============================================================
-- 1. UTILISATEURS (14 comptes répartis sur tous les rôles)
...
-- ============================================================
-- 2. PARCELLES (8 parcelles sur 3 secteurs)
-- ============================================================
...
-- ============================================================
-- 3. PLANTES (10 variétés couvrant printemps + été)
-- ============================================================
...
('Tomate Marmande',      'Variété ancienne à gros fruits charnus. Exige beaucoup de soleil et un tuteurage rapide.',                 3, 5, '2025-12-01', 7, 9),  -- 1
('Tomate Cerise',        'Petits fruits sucrés idéaux pour apéritif. Production prolongée jusqu''aux gelées.',                       3, 5, '2025-12-01', 7, 10), -- 2
('Carotte Nantaise',     'Sol meuble et sableux indispensable. Éviter les sols pierreux pour racines bien droites.',                 3, 6, '2025-12-01', 7, 10), -- 3
('Basilic Grand Vert',   'Craint le gel. Excellente association avec la tomate. Arrosage régulier au pied.',                          4, 6, '2025-12-15', 6, 9),  -- 4
('Radis de 18 jours',    'Croissance très rapide (3 semaines). Arrosage régulier pour éviter le piquant.',                            3, 9, '2025-12-20', 4, 10), -- 5
('Courgette Verte',      'Très productive : 1 à 2 pieds suffisent pour une famille. Récolter jeune.',                                 4, 6, '2026-01-10', 7, 10), -- 6
('Salade Batavia',       'Variété rustique adaptée toute saison. Semis échelonnés tous les 15 jours.',                                3, 9, '2026-01-15', 5, 10), -- 7
('Aubergine Violette',   'Chaleur indispensable. Tuteurer et pincer la tête après la 5ème fleur.',                                    4, 5, '2026-02-01', 7, 10), -- 8
('Poivron Doux',         'Très bonne association avec basilic et persil. Sensible aux excès d''eau.',                                 4, 5, '2026-02-01', 8, 10), -- 9
('Haricot Vert',         'Semis directs en pleine terre. Récolter tous les 2 jours pour stimuler la production.',                     5, 7, '2026-02-15', 7, 10); -- 10

-- ============================================================
-- 4. OUTILS (8 outils avec états variés)
-- ============================================================
INSERT INTO Outil (nomO, descriptionO, disponibiliteO, etat_physique) VALUES
('Bêche',             'Pelle avec manche en bois renforcé',          TRUE,  'Opérationnel'),    -- 1
('Râteau',            'Râteau à 14 dents en acier trempé',           TRUE,  'Opérationnel'),    -- 2
('Arrosoir',          'Arrosoir 10L en plastique vert',              TRUE,  'Opérationnel'),    -- 3
('Brouette',          'Brouette 90L roue gonflable',                 FALSE, 'Abîmé'),           -- 4
('Pelle',             'Pelle ronde manche bois',                     TRUE,  'Opérationnel'),    -- 5
('Sécateur',          'Sécateur professionnel lames forgées',        TRUE,  'Opérationnel'),    -- 6
('Cisaille',          'Cisaille à haies manche télescopique',        FALSE, 'Abîmé'),   -- 7
('Tuyau d''arrosage', 'Tuyau 25m avec enrouleur mural',              FALSE, 'HS');              -- 8

-- ============================================================
-- 5. MÉTÉO (Journal sur les 6 dernières semaines)
-- ============================================================
...
-- ============================================================
-- 6. SEMENCES (Grainothèque gérée par le Trésorier - id 11)
-- ============================================================
...
-- ============================================================
-- 7. CONSEILS CULTURAUX (Rédigés par les Tuteurs id 9 et 10)
-- ============================================================
...
-- ============================================================
-- 8. CONTRIBUTIONS (Dons des adhérents et visiteurs)
-- ============================================================
...
-- ============================================================
-- 9. ATTRIBUTIONS (Historique + attributions actives)
-- ============================================================
...
-- ============================================================
-- 10. RÉSERVATIONS D'OUTILS (Calendrier d'emprunts)
-- ============================================================
...
-- ============================================================
-- 12. CULTURES (Plantations sur les parcelles attribuées)
-- ============================================================
-- Culture passée
...
-- ============================================================
-- 13. RÉCOLTES (Pour les cultures terminées)
-- ============================================================
...
-- ============================================================
-- 14. ALERTES SANITAIRES (Mix résolu / en cours)
-- ============================================================
