...
if (isset($_GET['msg'])) {
    switch ($_GET['msg']) {
        case 'ok':      $msg = "<div class='alert alert-success'>" . icon('check') . " Stock mis à jour.</div>"; break;
        case 'invalid': $msg = "<div class='alert alert-error'>" . icon('warning') . " La quantité doit être positive ou nulle.</div>"; break;
        case 'db_err':  $msg = "<div class='alert alert-error'>" . icon('warning') . " Erreur lors de la mise à jour.</div>"; break;
    }
}
